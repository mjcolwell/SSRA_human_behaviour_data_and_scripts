...
setwd("C:/Users/mcolwell/Desktop/PrePostQuestionnaires_analysis")
...
ANCOVA_df_SE1 <- QuestionnairesMasterPost[c("Allocation", "Participant.ID", "Appetite.decrease","Appetite.increase","Drowsiness.fatigue","Insomnia","Sexual.side.effects","Sweating","Tremors","Agitation",
                                            "Anxiety","Diarrhoea","Dry.mouth","Indigestion","Nausea","Upset.stomach","SE.total")]
...
ANCOVA_df_SE2 <- QuestionnairesMasterPre[c("Allocation", "Participant.ID", "Appetite.decrease","Appetite.increase","Drowsiness.fatigue","Insomnia","Sexual.side.effects","Sweating","Tremors","Agitation",
                                            "Anxiety","Diarrhoea","Dry.mouth","Indigestion","Nausea","Upset.stomach","SE.total")]
...
ANCOVA_df_Full <- left_join(ANCOVA_df_SE1, ANCOVA_df_SE2, by = c("Participant.ID", "Allocation"))
...
ANCOVA_df_Qs1 <- QuestionnairesMasterPost[c("Allocation", "Participant.ID", "STAI.nonanx", "STAI.anx","BDI.total","PDQ.total","PANAS.neg","PANAS.pos","VAS.pos", "VAS.neg","Motivated")]
...
ANCOVA_df_Qs2 <- QuestionnairesMasterPre[c("Allocation", "Participant.ID", "STAI.nonanx", "STAI.anx","BDI.total","PDQ.total","PANAS.neg","PANAS.pos","VAS.pos", "VAS.neg","Motivated")]
...
ANCOVA_df_Full_Q <- left_join(ANCOVA_df_Qs1, ANCOVA_df_Qs2, by = c("Participant.ID", "Allocation"))
