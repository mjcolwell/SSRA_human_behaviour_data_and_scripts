...
Long_GoNo_SummaryAlt <- GoNo %>%
  ...
  summarise(GoRTmean = mean(GoRT, na.rm = TRUE), GoRTsd = sd(GoRT, na.rm = TRUE), RT_hits_corr = mean(RT_hits_corr, na.rm = TRUE), AccuratePress = sum(SP_pressed, na.rm = FALSE) / 120 * 100, AccurateNoPress = sum(SNP_nopress, na.rm = FALSE) / 40 * 100, InaccuratePress = sum(SP_fail, na.rm = FALSE), InaccurateNoPress = sum(SNP_fail, na.rm = FALSE))

Long_GoNo_SummaryAlt2 <- GoNo %>%
  group_by(Participant.ID, PRE.POST, HotorColdTrial, Express) %>%
...
SetShiftBoxplot <- Long_GoNo_SummaryRealTaskSetPostOnly %>% ggplot(aes(x = Allocation, y = AccurateNoPress, fill = Allocation)) +
  facet_wrap(~ as.factor(SetShift), nrow = 1) +
  geom_boxplot(width = 0.25, outlier.shape = NA) +
  scale_fill_brewer(palette = "Set2") +
  scale_color_brewer(palette = "Set2") +
  ...
  labs(title = " ") +
  ylab("Response inhibition accuracy\n") +
  xlab(" ") +
  theme_minimal() +
...
Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot <- Long_GoNo_SummaryRealTaskAltPostOnly

Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType <- recode_factor(Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType, "ConNoGoTrl" = "Control")
Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType <- recode_factor(Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType, "FearNoGoTrial" = "Negative interference")
Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType <- recode_factor(Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType, "HappyNoGoTrial" = "Positive interference")

Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(!str_detect(TrialType, "ConGoTrl"))
Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(!str_detect(TrialType, "FearGoTrial"))
Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(!str_detect(TrialType, "HappyGoTrial"))

Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType <- fct_relevel(Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot$TrialType, "Control", "Positive interference", "Negative interference")

######################################################################

GoAccuracyPlot <- Long_GoNo_SummaryRealTaskAltPostOnly %>% ggplot(aes(x = Allocation, y = AccuratePress, fill = Allocation)) +
  facet_wrap(~ as.factor(HotorColdTrial), nrow = 1) +
  geom_boxplot(width = 0.25, outlier.shape = NA) +
  scale_fill_brewer(palette = "Set2") +
  scale_color_brewer(palette = "Set2") +
  geom_signif(
  ...
  labs(title = " ") +
  ylab("Accuracy of responses to 'Go' trials\n") +
  xlab(" ") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14)) +
  stat_boxplot(
...
Boxplot_All <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% ggplot(aes(x = Allocation, y = AccurateNoPress, fill = Allocation)) +
  stat_slab(
  ...
  labs(title = " ") +
  ylab("Response inhibition (%)\n") +
  xlab(" ") +
  theme_minimal() +
  theme(
    legend.position = "none", text = element_text(size = 14), axis.text.y = element_text(size = 14), axis.title = element_text(size = 16), strip.text = element_blank(), axis.text.x = element_blank(),
    plot.margin = margin(t = 0, r = -20, l = 0, b = -60)
  ) +
  stat_boxplot(
    geom = "errorbar",
    width = 0.15
...
Control_Only_df <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(str_detect(TrialType, "Control"))
...
Boxplot_Control <- Control_Only_df %>% ggplot(aes(x = Allocation, y = AccurateNoPress, fill = Allocation)) +
  ...
  geom_signif(
    comparisons = list(c("ACTIVE", "PLACEBO")),
    map_signif_level = c("***" = 0.001, "**" = 0.01, "*" = 0.05, " " = 0.20), test = "t.test",
    margin_top = 0.05
  ) +
  scale_fill_brewer(palette = "Set2") +
  scale_color_brewer(palette = "Set2") +
...
Happy_Only_df <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(str_detect(TrialType, "Positive interference"))
...
Fear_Only_df <- Long_GoNo_SummaryRealTaskAltPostOnlyAccPlot %>% filter(str_detect(TrialType, "Negative interference"))

Boxplot_Negative <- Fear_Only_df %>% ggplot(aes(x = Allocation, y = AccurateNoPress, fill = Allocation)) +
  stat_slab(
    side = "right", scale = 0.5, show.legend = F,
    position = position_dodge(width = .8), alpha = 0.5,
    aes(fill_ramp = stat(level)), .width = c(.50, .95, 1)
  ...
  geom_signif(
    comparisons = list(c("ACTIVE", "PLACEBO")),
    p.adjust.method = "holm",
    map_signif_level = c("***" = 0.001, "**" = 0.01, "**" = 0.05, " " = 0.20), # changed manually to reflect emmeans
    margin_top = 0.05, textsize = 10
  ) +
  labs(title = " ") +
  ylab(" ") +
...
BoxplotCombined1 <- plot_grid(Boxplot_All, Boxplot_Control, Boxplot_Happy, Boxplot_Negative, nrow = 1, align = "h")
...
Boxplot_RT_all <- Long_GoNo_SummaryRealTaskAltPostOnlyRTPlot %>% ggplot(aes(x = Allocation, y = GoRTmean, fill = Allocation)) +
  stat_slab(
    side = "right", scale = 0.5, show.legend = F,
    position = position_dodge(width = .8), alpha = 0.5,
    aes(fill_ramp = stat(level)), .width = c(.50, .95, 1)
  ...
  geom_signif(
    comparisons = list(c("ACTIVE", "PLACEBO")),
    p.adjust.method = "holm",
    map_signif_level = c("****" = 0.0001, "***" = 0.001, "**" = 0.01, "*" = 0.05, " " = 0.20),
    margin_top = 0.05, textsize = 10
  ) +
  labs(title = " ") +
  ...
  xlab(" ") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.text.y = element_text(size = 14), axis.title = element_text(size = 16), strip.text = element_blank(), plot.margin = margin(t = 0, r = -20, l = 0, b = 0)) +
  stat_boxplot(
    geom = "errorbar",
    width = 0.15
  ) +
...
Boxplot_RT_control <- Control_Only_df %>% ggplot(aes(x = Allocation, y = GoRTmean, fill = Allocation)) +
  stat_slab(
    side = "right", scale = 0.5, show.legend = F,
    position = position_dodge(width = .8), alpha = 0.5,
    aes(fill_ramp = stat(level)), .width = c(.50, .95, 1)
  ...
  xlab(" ") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.title = element_text(size = 16), axis.text.y = element_blank(), strip.text = element_blank(), plot.margin = margin(t = 0, r = -20, l = 0, b = 0)) +
  stat_boxplot(
    geom = "errorbar",
    width = 0.15
  ) +
...
Boxplot_RT_happy <- Happy_Only_df %>% ggplot(aes(x = Allocation, y = GoRTmean, fill = Allocation)) +
  stat_slab(
    side = "right", scale = 0.5, show.legend = F,
    position = position_dodge(width = .8), alpha = 0.5,
    aes(fill_ramp = stat(level)), .width = c(.50, .95, 1)
  ...
  xlab(" ") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.text.y = element_blank(), axis.title = element_text(size = 16), strip.text = element_blank(), plot.margin = margin(t = 0, r = -20, l = 0, b = 0)) +
  stat_boxplot(
    geom = "errorbar",
    width = 0.15
  ) +
...
Boxplot_RT_fear <- Fear_Only_df %>% ggplot(aes(x = Allocation, y = GoRTmean, fill = Allocation)) +
  stat_slab(
    side = "right", scale = 0.5, show.legend = F,
    position = position_dodge(width = .8), alpha = 0.5,
    aes(fill_ramp = stat(level)), .width = c(.50, .95, 1)
...
BoxplotCombined2 <- plot_grid(Boxplot_RT_all, Boxplot_RT_control, Boxplot_RT_happy, Boxplot_RT_fear, nrow = 1, align = "h")

Master_boxplot <- plot_grid(BoxplotCombined1, NULL, BoxplotCombined2, ncol = 1, align = "v", rel_heights = c(0.80, -0.15, 0.90))
...
Boxplot_criterion_all <- MasterGNGwideAlt2Post %>% ggplot(aes(x = Allocation, y = c, fill = Allocation)) +
  ...
  geom_signif(
    comparisons = list(c("ACTIVE", "PLACEBO")),
    p.adjust.method = "holm",
    map_signif_level = c("****" = 0.0001, "***" = 0.001, "**" = 0.01, "**" = 0.05, " " = 0.20), # Edited to match EMM
    margin_top = 0.05, textsize = 10
  ) +
  labs(title = " ") +
...
ANCOdf3 <- Long_GoNo_SummaryRealTaskSetPostOnly[c("Allocation", "Participant.ID", "AccurateNoPress", "GoRTmean", "SetShift")]

ANCOdf3 <- rename(ANCOdf3, AccurateNoPressPost = AccurateNoPress)
ANCOdf3 <- rename(ANCOdf3, GoRTmeanPost = GoRTmean)

ANCOdf4 <- Long_GoNo_SummaryRealTaskSetPreOnly[c("Allocation", "Participant.ID", "AccurateNoPress", "GoRTmean", "SetShift")]

ANCOdf4 <- rename(ANCOdf4, AccurateNoPressPre = AccurateNoPress)
ANCOdf4 <- rename(ANCOdf4, GoRTmeanPre = GoRTmean)

ANCOdfcomp2 <- left_join(ANCOdf3, ANCOdf4, by = c("Participant.ID", "Allocation", "SetShift"))
...
ancova_model2 <- aov(GoRTmeanPost ~ Allocation + GoRTmeanPre + SetShift + Allocation:SetShift + Error(Participant.ID), data = ANCOdfcomp2)

summary(ancova_model2)

#No effect specifically for allocation*setshift

#Get effect size for setshift effect

lm_model <- lmer(GoRTmeanPost ~ Allocation + SetShift + Allocation:SetShift + GoRTmeanPre + (1 | Participant.ID), data = ANCOdfcomp2)

eta_squared(lm_model, ci = 0.95, alternative="two.sided")

# Main analysis

ANCOdf1 <- Long_GoNo_SummaryRealTaskAltPostOnly[c("Allocation", "Participant.ID", "AccurateNoPress", "AccuratePress", "GoRTmean", "TrialType", "HotorColdTrial")]
...
ANCOdf2 <- Long_GoNo_SummaryRealTaskAltPreOnly[c("Allocation", "Participant.ID", "AccurateNoPress", "AccuratePress", "GoRTmean", "TrialType", "HotorColdTrial")]
...
ANCOdfcomp <- left_join(ANCOdf1, ANCOdf2, by = c("Participant.ID", "Allocation", "TrialType", "HotorColdTrial"))
...
# Calculate estimated marginal means (EMMs) for Allocation effect only
...
ANCOVA_Comm_RT <- aov(AccuratePressPost ~ Allocation + TrialType + Allocation:TrialType + AccuratePressPre + Error(Participant.ID),
  data = ANCOdfcomp
)
...
ANCOdf1 <- MasterGNGwideAlt2Post[c("Allocation", "Participant.ID", "dprime", "beta", "c", "Express", "HotorColdTrial")]

ANCOdf1 <- rename(ANCOdf1, dprimePost = dprime)
ANCOdf1 <- rename(ANCOdf1, betaPost = beta)
ANCOdf1 <- rename(ANCOdf1, cPost = c)

ANCOdf2 <- MasterGNGwideAlt2Pre[c("Allocation", "Participant.ID", "dprime", "beta", "c", "Express", "HotorColdTrial")]

ANCOdf2 <- rename(ANCOdf2, dprimePre = dprime)
ANCOdf2 <- rename(ANCOdf2, betaPre = beta)
ANCOdf2 <- rename(ANCOdf2, cPre = c)

ANCOdfcomp <- left_join(ANCOdf1, ANCOdf2, by = c("Participant.ID", "Allocation", "Express"))
